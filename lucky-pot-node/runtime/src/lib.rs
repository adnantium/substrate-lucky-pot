...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("lucky-pot-node"),
	impl_name: create_runtime_str!("lucky-pot-node"),
	authoring_version: 3,
	spec_version: 3,
	impl_version: 0,
...
impl luckypot::Trait for Runtime { 
	// type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		// LuckyPot: luckypot::{Module, Call, Storage, Event<T>},
		LuckyPot: luckypot::{Module, Call, Storage},
	}
);
